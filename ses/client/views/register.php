	...
	<form method='get' action='controllers/actionRegister.php' id='registerform'>
		...
		<input id=registeraddr name=registeraddr type=text value="" /><span class='afterfield'>::<?php echo $SES_SERVER; ?></span>

		<br /><br />	

		<!-- password -->
		<label for=registerpwd >Password : </label>
		<input id=registerpwd name=registerpwd type=password value="" /><span class='afterfield'>At least 6 characters !</span>

		<br /><br />
		
		<!-- mail -->
		<label for=registermail>Mail: </label>
		<input id=registermail name=registermail type=text value="" /><span class='afterfield'>Used for Gravatars.</span>
